        ...
        <div className="container relative z-20">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-10 max-w-3xl leading-relaxed">
              Tamara Jewelries is your trusted destination for elegant fine gold jewelry with flexible payment options, including instant purchase, installments, and an Ajo/Adashi savings plan. We
              make luxury jewelry accessible, secure, and stress-free, helping you confidently own timeless pieces whether for yourself, as a gift, or for a growing collection.
            </p>
      ...
      <section className="py-24 bg-card border-y border-border">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="font-playfair text-3xl md:text-4xl font-bold mb-4">Why Choose Tamara Jewellery?</h2>
            <p className="text-muted-text text-lg">We combine elegance, trust, flexibility, and affordability to make premium jewelry ownership easier for every woman who loves timeless beauty.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {whyChooseTamara.map((item, index) => {
              ...
              return (
                <div key={index} className="flex gap-4 p-6 rounded-xl bg-background border border-border hover:border-primary/30 transition-colors group">
                  ...
                  <div>
                    <h4 className="font-playfair font-semibold text-foreground mb-1">{item.title}</h4>
      ...
      <section className="py-24 bg-background border-t border-border relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center max-w-3xl relative z-10">
          ...
          <p className="text-muted-text text-lg leading-relaxed mb-10">
            Whether it's your first gold piece, a gift for someone special, or a collection you've always desired — create an account today and start owning it confidently and conveniently.
          </p>
